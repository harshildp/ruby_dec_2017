...
require 'open-uri'
teams = [
  ["Atlanta Hawks", "Harry the Hawk", "Philips Arena"],
  ...
  ["Detroit Pistons", "Hooper", "Little Caesars Arena"],
  ...
  ["Phoenix Suns", "Go the Gorilla", "Talking Stick Resort Arena"],
...
players.each_with_index do |roster, index|
  Team.create(name: teams[index][0], mascot: teams[index][1], arena: teams[index][2])
